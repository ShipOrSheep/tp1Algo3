...
Pudimos ver que el método de Fuerza Bruta no es viable en ninguna situación, pues tardará tiempo exponencial para cualquier instancia mientras que Backtracking y Programación Dinámica mejoran esa cota de complejidad en casos promedios para resolver el mismo problema. Sin embargo facilidad en la codificación nos permitió utilizarlo para verificar los resultados de los métodos más complejos.
